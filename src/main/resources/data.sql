...
('john_doe', 'tizzifona@gmail.com', '$2a$10$HsMF2wIVlZAelTWGNHD/r.lbHJemKWx0.HEfqHKHF91CR8R3fDjX2'),
...
-- John's destinations
('Paradise Beach', 'Bali, Indonesia', 'A stunning tropical paradise with crystal clear waters and white sandy beaches. Perfect for relaxation and water sports.', 'https://images.unsplash.com/photo-1537953773345-d172ccf13cf1', 3, '2023-06-15 14:30:00', '2023-06-20 09:15:00'),
('Mountain Retreat', 'Swiss Alps', 'Breathtaking mountain views with cozy chalets and world-class skiing opportunities. A winter wonderland for adventure seekers.', 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4', 3, '2023-08-22 11:45:00', '2023-09-05 16:20:00'),
('Desert Oasis', 'Sahara Desert, Morocco', 'Experience the magic of the desert with camel treks, traditional Berber camps, and stunning starry nights.', 'https://images.unsplash.com/photo-1509316785289-025f5b846b35', 3, '2023-10-08 08:20:00', '2023-10-12 13:45:00'),

-- Jane's destinations
('Cherry Blossom Festival', 'Tokyo, Japan', 'Witness the magical cherry blossom season in Japan. Beautiful parks, traditional temples, and amazing food culture.', 'https://images.unsplash.com/photo-1522383225653-ed111181a951', 4, '2023-04-12 16:00:00', '2023-04-18 10:30:00'),
('Northern Lights', 'Reykjavik, Iceland', 'Chase the aurora borealis in Iceland. Hot springs, glaciers, and the most spectacular light show on Earth.', 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7', 4, '2023-11-30 19:15:00', '2023-12-10 14:00:00'),
('Amazon Adventure', 'Manaus, Brazil', 'Explore the world''s largest rainforest. Wildlife watching, river cruises, and indigenous culture experiences.', 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e', 4, '2023-07-03 12:45:00', '2023-07-15 17:30:00'),

-- Mike's destinations
('Great Wall Trek', 'Beijing, China', 'Walk along the ancient Great Wall of China. Rich history, stunning architecture, and panoramic mountain views.', 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d', 5, '2023-05-20 09:30:00', '2023-05-25 11:45:00'),
('Venice Canals', 'Venice, Italy', 'Float through the romantic canals of Venice. Historic architecture, gondola rides, and authentic Italian cuisine.', 'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9', 5, '2023-09-14 15:20:00', '2023-09-22 08:50:00'),
('Machu Picchu', 'Cusco, Peru', 'Discover the ancient Incan citadel high in the Andes. Archaeological wonder and breathtaking mountain scenery.', 'https://images.unsplash.com/photo-1587595431973-160d0d94add1', 5, '2023-12-05 06:00:00', '2023-12-12 18:30:00'),

-- Sarah's destinations
('Santorini Sunset', 'Santorini, Greece', 'Experience the most beautiful sunsets in the world. White-washed buildings, blue domes, and Mediterranean charm.', 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff', 6, '2023-03-28 13:15:00', '2023-04-02 20:45:00'),
('Taj Mahal', 'Agra, India', 'Visit the iconic symbol of love. Marvel at the stunning white marble architecture and rich Mughal history.', 'https://images.unsplash.com/photo-1564507592333-c60657eea523', 6, '2023-06-08 10:00:00', '2023-06-15 14:20:00'),
('Serengeti Safari', 'Tanzania', 'Go on an African safari adventure. Witness the great migration and see the Big Five in their natural habitat.', 'https://images.unsplash.com/photo-1549366021-9f761d450615', 6, '2023-08-01 07:30:00', '2023-08-08 16:15:00'),

-- David's destinations
('New York City', 'New York, USA', 'The city that never sleeps. Broadway shows, world-class museums, and iconic landmarks like Times Square.', 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9', 7, '2023-02-15 18:45:00', '2023-02-22 12:30:00'),
('Sydney Opera House', 'Sydney, Australia', 'Iconic architecture and harbor views. Opera performances, guided tours, and beautiful coastal walks.', 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9', 7, '2023-10-25 21:00:00', '2023-11-02 09:15:00'),
('Petra Ancient City', 'Jordan', 'Explore the ancient Nabatean city carved into red sandstone cliffs. Archaeological wonder and desert beauty.', 'https://images.unsplash.com/photo-1551698618-1dfe5d97d256', 7, '2023-01-10 14:20:00', '2023-01-18 11:45:00');
